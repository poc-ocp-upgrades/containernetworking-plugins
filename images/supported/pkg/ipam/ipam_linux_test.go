...
var _ = Describe("ConfigureIface", func() {
	...
	BeforeEach(func() {
		...
		err = originalNS.Do(func(ns.NetNS) error {
			defer GinkgoRecover()
			err = netlink.LinkAdd(&netlink.Dummy{LinkAttrs: netlink.LinkAttrs{Name: LINK_NAME}})
			Expect(err).NotTo(HaveOccurred())
		...
		result = &current.Result{Interfaces: []*current.Interface{{Name: "eth0", Mac: "00:11:22:33:44:55", Sandbox: "/proc/3553/ns/net"}, {Name: "fake0", Mac: "00:33:44:55:66:77", Sandbox: "/proc/1234/ns/net"}}, IPs: []*current.IPConfig{{Version: "4", Interface: current.Int(0), Address: *ipv4, Gateway: ipgw4}, {Version: "6", Interface: current.Int(0), Address: *ipv6, Gateway: ipgw6}}, Routes: []*types.Route{{Dst: *routev4, GW: routegwv4}, {Dst: *routev6, GW: routegwv6}}}
	})
	AfterEach(func() {
	...
	It("does not panic when interface is not specified", func() {
		result = &current.Result{Interfaces: []*current.Interface{{Name: "eth0", Mac: "00:11:22:33:44:55", Sandbox: "/proc/3553/ns/net"}, {Name: "fake0", Mac: "00:33:44:55:66:77", Sandbox: "/proc/1234/ns/net"}}, IPs: []*current.IPConfig{{Version: "4", Address: *ipv4, Gateway: ipgw4}, {Version: "6", Address: *ipv6, Gateway: ipgw6}}}
		err := originalNS.Do(func(ns.NetNS) error {
			return ConfigureIface(LINK_NAME, result)
		})
		Expect(err).NotTo(HaveOccurred())
